...
<div class="row">
        ...
        <?php if ( have_posts() ) : ?>
				<h2 class="entry-title themecolor">
					<?php
						if ( is_day() ) :
							printf( __( 'Daily Archives: %s', 'graffiti' ), get_the_date() );

						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: %s', 'graffiti' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'graffiti' ) ) );

						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: %s', 'graffiti' ), get_the_date( _x( 'Y', 'yearly archives date format', 'graffiti' ) ) );

						else :
							_e( 'Archives', 'graffiti' );
